                                    ...
                                    <div id="salads" class="navbar-collapse collapse  wrap-none">
                                       ...
                                       <div class="menu-items">
                                          ...
                                          <div id="menu83" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/grifish.jpg">
                                                   <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/grilfish.jpg"> 
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                             ...
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail mySlides2" alt="seafood salad" src="images/beefsuy.jpg">
                                                    <img class="img-responsive img-thumbnail mySlides2" alt="seafood salad" src="images/suya.png">
                                    ...
                                    <div id="seafoods" class="navbar-collapse collapse  wrap-none">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu80" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="special shrimp deluxe" src="images/whiteass.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                         ...
                                         <div id="menu78" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/cocrice.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                     ...
                                     <div id="menu78" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/friedrice.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                         ...
                                         <div id="menu80" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/yampo.jpeg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu80" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="special shrimp deluxe" src="images/jolo.jpeg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
