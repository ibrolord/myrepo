...
<html xmlns='http://www.w3.org/1999/xhtml' lang='en'>
   ...
   <body class=''>
      ...
      <div id='slider' style='width:100%;'>
         <img src=' assets/image-slider-1.jpg ' alt='Welcome to FoodApp '/>
         <img src='assets/image-slider-2.jpg ' alt='Welcome to FoodApp '/>
         <img src='assets/image-slider-3.jpg ' alt='Welcome to FoodApp ' />
      </div>
               ...
               <div class='location-list col-sm-9'>
                     ...
                     <div class='panel-body'>
                        <div class='row'>
                           <div class='box-one col-xs-12 col-sm-5'>
                              <img class='img-responsive pull-left' src='assets/LaMer-Logo_636140429107732006.jpg'/>
                              <dl>
                                 <dd>

                                    <h4>Buffalo Wings & Rings Oman</h4>
                                 </dd>
                                 <dd>
                                 ...
                                 <dd><span class='text-muted'>44 Darnley Road<br />Greater London E9 6QH</span></dd>
                           ...
                           <div class='col-xs-6 col-sm-4'>
                              <dl>
                                 ...
                                 <dt> $status </dt>
                                 <dd class='text-muted'>
                                    Delivery in <b>20</b> minutes																																										
                                 </dd>
                                 <dd class='text-muted'>
                                    Pick-up in <b>10</b> minutes																																										
                                 </dd>
                  ...
                  <div class='panel panel-local'>
                     <div class='panel-body'>
                        <div class='row'>
                           <div class='box-one col-xs-12 col-sm-5'>
                              <img class='img-responsive pull-left' src='assets/Pastry-Logo_635161460789568362.jpg'/>
                              <dl>
                                 <dd>
                                 

                                    <h4>Hackney's Branch</h4>
                                 </dd>
                                 <dd>
                                    <div class='rating rating-sm text-muted'>
                                       <span class='fa fa-star'></span><span class='fa fa-star'></span><span class='fa fa-star'></span><span class='fa fa-star-half-o'></span><span class='fa fa-star-o'></span>
