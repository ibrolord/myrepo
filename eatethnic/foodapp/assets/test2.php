                                    ...
                                    <div id="appetizer" class="navbar-collapse collapse in wrap-none">
                                          ...
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-nokne wrap-right">
                                                   <img class="img-responsive img-thumbnail img" alt="Puff Puff" src="images/stbee.jpg">
                                                </div>
                                          ...
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail img" alt="Chin Chin" src="images/redsna.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="Fish Roll" src="images/ackee.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="scotch egg" src="images/fchi.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                          ...
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="samosa" src="images/oxtarot.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                        ...
                                        <div class="menu-items">
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="samosa" src="images/veggi.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                        ...
                                        <div class="menu-items">
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="samosa" src="images/kinfi.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                          ...
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="samosa" src="images/jchi.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                          ...
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="samosa" src="images/jpor.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu77" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="scotch egg" src="images/babchi.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                    ...
                                    <div id="main-course" class="navbar-collapse collapse  wrap-none">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu84" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="egusi" src="images/jerkchi.jpeg">
                                                      </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                           ...
                                           <div id="menu78" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/shrisand.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                             ...
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/stewsand.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                    ...
                                    <div id="salads" class="navbar-collapse collapse  wrap-none">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu82" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                    ...
                                                    <img class="img-responsive img-thumbnail" alt="seafood salad" src="images/jchick.jpg">
                                                </div>
                                          ...
                                          <div id="menu83" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/jerpork.jpg">
                                             <!--      <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/cbrs.jpg">   -->
                                                ...
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                                   ...
                                                   <span class="menu-desc ">
                                                       6 pieces (2 CAD for 3 pieces) <br> <dd class="text-muted"> Grace is open to requests regarding the preferred fish to be selected. If you would like for it to be Fried, Grilled or Sauced you can give her a prefence		</dd>	</span>
                                                </div>
                                                <div class="menu-right col-xs-4 wrap-none">
                                            ...
                                            <div id="menu83" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/jplan.jpg">
                                                 <!--  <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/cbrs.jpg"> -->
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                             ...
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/cocbre.jpg">
                                                 <!--  <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/cbrs.jpg"> -->
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                             ...
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/patty.jpg">
                                                 <!--  <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/cbrs.jpg"> -->
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                             ...
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/coleslaw.jpg">
                                                 <!--  <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/cbrs.jpg"> -->
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                             ...
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/plantain.jpg">
                                                 <!--  <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/cbrs.jpg"> -->
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                           ...
                                           <div id="menu83" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail mySlides" alt="seafood salad" src="images/redsnapper.jpg">
                                                    <img class="img-responsive img-thumbnail mySlides" alt="seafood salad" src="images/kinfish.jpg">
                                               </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                             ...
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                    <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/jfestiv.jpg">
                                                    <img class="img-responsive img-thumbnail mySlides1" alt="seafood salad" src="images/jamdump.jpg">
                                               </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                            ...
                                            <div id="menu83" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/befstew.jpg">
                                              </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                            ...
                                            <div id="menu83" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail " alt="seafood salad" src="images/cbrs.jpg">
                                               </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                          ...
                                          <div id="menu83" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                               ...
                                               <!--    <img class="img-responsive img-thumbnail mySlides2" alt="seafood salad" src="images/beefsuy.jpg">    -->
                                                    <img class="img-responsive img-thumbnail mySlides2" alt="seafood salad" src="images/cushrimp.jpg">
                                    ...
                                    <div id="seafoods" class="navbar-collapse collapse  wrap-none">
                                       ...
                                       <div class="menu-items">
                                          <div id="menu80" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="special shrimp deluxe" src="images/rum.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                                   <span class="menu-name"><b>Rumcake</b></span>
                                                   <span class="menu-desc">
                                                   A plate<br><dd class="text-muted">White rice is milled rice that has had its husk, bran, and germ removed. This alters the flavor, texture and appearance of the rice and helps prevent spoilage and extend its storage life.		</dd>									</span>
                                                </div>
                                                <div class="menu-right col-xs-4 wrap-none">
                                         ...
                                         <div id="menu78" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/drops.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                     ...
                                     <div id="menu78" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/pea.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                         ...
                                         <div id="menu78" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail" alt="ata rice" src="images/gizza.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
                                         ...
                                         <div id="menu80" class="menu-item">
                                             <div class="menu-item-wrapper row">
                                                <div class="menu-thumb col-xs-2 col-sm-2 wrap-none wrap-right">
                                                   <img class="img-responsive img-thumbnail mySlides3" alt="ata rice" src="images/beefsoup.jpg">
                                                   <img class="img-responsive img-thumbnail mySlides3" alt="ata rice" src="images/vegesoup.jpg">
                                                </div>
                                                <div class="menu-content col-xs-6 col-sm-6 wrap-none wrap-right">
